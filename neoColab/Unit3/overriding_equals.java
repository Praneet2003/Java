...
class WordEntry{
    ...
    public boolean equals(Object obj){
        ...
        String normalizedWord1 = word.replaceAll("\\s","").toLowerCase();
        String normalizedWord2 = other.word.replaceAll("\\s","").toLowerCase();
        return normalizedWord1.equals(normalizedWord2);
    }
}
class overriding_equals{
